...
#
# PURPOSE:
#       Display some desired fields of the Rally UserStory given on the
#   command line.
#
# USAGE:
...
$my_project     = "RIMU_requirements"

require "rally_api"
require "debugger"

if ARGV[0].nil? then
    print "USAGE: #{$0} <FormattedID of an existing UserStory>\n"
    exit
else
    my_us=ARGV[0]
end
...
print "Query Rally for UserStory (hierarichalrequirement) #{my_us}...\n"
...
#
print "Found UserStory (hierarichalrequirement):\n"
fn = 1
